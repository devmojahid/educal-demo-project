...
@section('title', 'Educal – Online Learning and Education HTML5 Template ')
    ...
    <main>
        ...
        <section class="hero__area hero__height hero__height-2 d-flex align-items-center blue-bg-3 p-relative fix">
            <div class="hero__shape">
                <img class="hero-1-circle" src="{{ asset('frontend') }}/assets/img/shape/hero/hero-1-circle.png"
                    alt="">
                <img class="hero-1-circle-2" src="{{ asset('frontend') }}/assets/img/shape/hero/hero-1-circle-2.png"
                    alt="">
                        ...
                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                            <div class="hero__content hero__content-2 p-relative z-index-1">
                                <h3 class="hero__title hero__title-2">
                                    Launch your <br> Own
                                    <span class="yellow-shape">online <img
                                            src="{{ asset('frontend') }}/assets/img/shape/yellow-bg.png" alt="yellow-shape">
                                    </span>
                                    learning Platform
                                </h3>
                        ...
                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                            <div class="hero__thumb-wrapper mb--120">
                                <div class="hero__thumb-2 scene">
                                    <img class="hero-big" src="{{ asset('frontend') }}/assets/img/hero/hero-2/hero.png"
                                        alt="">
                                    <img class="hero-shape-purple"
                                        src="{{ asset('frontend') }}/assets/img/hero/hero-2/hero-shape-purple.png"
                                        alt="">
                                    ...
                                    <div class="hero__promotion education d-none d-lg-flex white-bg layer" data-depth="0.2">
                                        ...
                                        <div class="hero__promotion-text">
                                            <h5><span data-purecounter-duration="1" data-purecounter-end="450"
                                                    class="purecounter">0</span>K</h5>
                                            <p>Assisted Student</p>
                                        </div>
                                    </div>
                                    <div class="hero__class d-none d-lg-flex layer" data-depth="0.3">
                                        <div class="hero__class-thumb mr-15">
                                            <img src="{{ asset('frontend') }}/assets/img/hero/hero-2/hero-sm.jpg"
                                                alt="">
                                        </div>
                ...
                <div class="row">
                    <div class="col-xxl-6 offset-xxl-3 col-xl-6 offset-xl-3">
                        <div class="section__title-wrapper section-padding mb-60 text-center">
                            <h2 class="section__title">Why an <span class="yellow-bg">scholercity <img
                                        src="{{ asset('frontend') }}/assets/img/shape/yellow-bg-2.png"
                                        alt=""></span> out of The
                                ordinary</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
                        <div class="services__item purple-bg mb-30">
                            ...
                            <div class="services__content">
                                <h3 class="services__title"><a href="about.html">Lifetime<br> Slack chat support</a>
                                </h3>
                                <p>Arse over tit morish wind up gormless butty.!</p>
                    ...
                    <div class="col-xxl-5 offset-xxl-1 col-xl-6 col-lg-6">
                        <div class="about__thumb-wrapper">
                            ...
                            <div class="about__student ml-270 mt--80">
                                <a href="#">
                                    <img src="{{ asset('frontend') }}/assets/img/about/student-4.jpg" alt="">
                ...
                <div class="row grid">
                        ...
                        <div class="course__item white-bg mb-30 fix">
                            <div class="course__thumb w-img p-relative fix">
                                <a href="course-details.html">
                                    <img src="{{ asset('frontend') }}/assets/img/course/course-1.jpg" alt="">
                                </a>
                    ...
                    <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 grid-item cat2 cat3 cat4">
                        <div class="course__item white-bg mb-30 fix">
                            <div class="course__thumb w-img p-relative fix">
                                <a href="course-details.html">
                                    <img src="{{ asset('frontend') }}/assets/img/course/course-2.jpg" alt="">
                                </a>
                                <div class="course__tag">
                            ...
                            <div class="course__content">
                                ...
                                <div class="course__teacher d-flex align-items-center">
                                    <div class="course__teacher-thumb mr-15">
                                        <img src="{{ asset('frontend') }}/assets/img/course/teacher/teacher-2.jpg"
                                            alt="">
                                    </div>
                    ...
                    <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 grid-item cat3 cat4 cat3">
                        <div class="course__item white-bg mb-30 fix">
                            <div class="course__thumb w-img p-relative fix">
                                <a href="course-details.html">
                                    <img src="{{ asset('frontend') }}/assets/img/course/course-3.jpg" alt="">
                                </a>
                                <div class="course__tag">
                            ...
                            <div class="course__content">
                                ...
                                <div class="course__teacher d-flex align-items-center">
                                    <div class="course__teacher-thumb mr-15">
                                        <img src="{{ asset('frontend') }}/assets/img/course/teacher/teacher-3.jpg"
                                            alt="">
                                    </div>
                    ...
                    <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 grid-item cat4 cat1 cat3">
                        <div class="course__item white-bg mb-30 fix">
                            <div class="course__thumb w-img p-relative fix">
                                <a href="course-details.html">
                                    <img src="{{ asset('frontend') }}/assets/img/course/course-4.jpg" alt="">
                                </a>
                                <div class="course__tag">
                            ...
                            <div class="course__content">
                                ...
                                <div class="course__teacher d-flex align-items-center">
                                    <div class="course__teacher-thumb mr-15">
                                        <img src="{{ asset('frontend') }}/assets/img/course/teacher/teacher-4.jpg"
                                            alt="">
                                    </div>
                    ...
                    <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 grid-item cat1 cat2 cat4">
                        <div class="course__item white-bg mb-30 fix">
                            <div class="course__thumb w-img p-relative fix">
                                <a href="course-details.html">
                                    <img src="{{ asset('frontend') }}/assets/img/course/course-5.jpg" alt="">
                                </a>
                                <div class="course__tag">
                            ...
                            <div class="course__content">
                                ...
                                <div class="course__teacher d-flex align-items-center">
                                    <div class="course__teacher-thumb mr-15">
                                        <img src="{{ asset('frontend') }}/assets/img/course/teacher/teacher-5.jpg"
                                            alt="">
                                    </div>
                    ...
                    <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 grid-item cat2 cat3">
                        <div class="course__item white-bg mb-30 fix">
                            <div class="course__thumb w-img p-relative fix">
                                <a href="course-details.html">
                                    <img src="{{ asset('frontend') }}/assets/img/course/course-6.jpg" alt="">
                                </a>
                                <div class="course__tag">
                            ...
                            <div class="course__content">
                                ...
                                <div class="course__teacher d-flex align-items-center">
                                    <div class="course__teacher-thumb mr-15">
                                        <img src="{{ asset('frontend') }}/assets/img/course/teacher/teacher-6.jpg"
                                            alt="">
                                    </div>
                    ...
                    <div class="col-xxl-5 col-xl-5 col-lg-6 col-md-8">
                        <div class="why__thumb">
                            ...
                            <img class="why-pink" src="{{ asset('frontend') }}/assets/img/why/why-shape-pink.png"
                                alt="">
                            <img class="why-dot" src="{{ asset('frontend') }}/assets/img/why/why-shape-dot.png"
                                alt="">
        ...
        <section class="testimonial__area testimonial__overlay pt-175 pb-170"
            data-background="{{ asset('frontend') }}/assets/img/testimonial/testimonial-bg.jpg">
            <div class="container">
                        ...
                        <div class="testimonial__slider-inner swiper-wrapper">
                            <div class="testimonial__item text-center swiper-slide">
                                <div class="testimonial__thumb">
                                    <img src="{{ asset('frontend') }}/assets/img/testimonial/testi-1.jpg" alt="">
                                </div>
                                ...
                                <div class="blog__meta d-flex align-items-center justify-content-between">
                                    <div class="blog__author d-flex align-items-center">
                                        <div class="blog__author-thumb mr-10">
                                            <img src="{{ asset('frontend') }}/assets/img/blog/author/author-1.jpg"
                                                alt="">
                                        </div>
                        ...
                        <div class="blog__item white-bg mb-30 transition-3 fix">
                            ...
                            <div class="blog__content">
                                ...
                                <div class="blog__meta d-flex align-items-center justify-content-between">
                                    <div class="blog__author d-flex align-items-center">
                                        <div class="blog__author-thumb mr-10">
                                            <img src="{{ asset('frontend') }}/assets/img/blog/author/author-2.jpg"
                                                alt="">
                                        </div>
                                        <div class="blog__author-info">
                                            <h5>Barry Tone</h5>
                        ...
                        <div class="blog__item white-bg mb-30 transition-3 fix">
                            ...
                            <div class="blog__content">
                                ...
                                <div class="blog__meta d-flex align-items-center justify-content-between">
                                    <div class="blog__author d-flex align-items-center">
                                        <div class="blog__author-thumb mr-10">
                                            <img src="{{ asset('frontend') }}/assets/img/blog/author/author-3.jpg"
                                                alt="">
                                        </div>
                                        <div class="blog__author-info">
                                            <h5>Barry Tone</h5>
